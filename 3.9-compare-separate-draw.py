...
INPUT_PATH = os.path.join("exp_result", "exp_compare_separate_draw.csv")
RESULT_PATH = os.path.join("exp_result", "compare_separate.png")
RESULT_PATH_EPS = os.path.join("exp_result", "compare_separate.eps")

df = pd.read_csv(INPUT_PATH)
type_array = ["bit-packing", "separate"]
dataset_array = [
    "temperature",
    "volt",
    "power",
