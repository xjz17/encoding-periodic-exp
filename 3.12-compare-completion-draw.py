...
INPUT_PATH = os.path.join("exp_result", "exp_compare_completion_draw.csv")
RESULT_PATH = os.path.join("exp_result", "compare_completion.png")
RESULT_PATH_EPS = os.path.join("exp_result", "compare_completion.eps")

df = pd.read_csv(INPUT_PATH)
type_array = ["direct", "completion"]
dataset_array = [
    "temperature",
    "volt",
    "power",
